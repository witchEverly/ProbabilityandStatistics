...
## Estimation with a Normal Distribution
...
> $Y \sim N(\Sigma a_i^2 \mu_i, \Sigma a_i^2 \sigma_i^2)$
...
## Bias/Unbias Estimators

## Maximum Likelihood Estimation

Then the linear combination $Y = a_1X_1 + a_2X_2 + ... a_nX_n = \Sigma a_i^2 \sigma_i^2$

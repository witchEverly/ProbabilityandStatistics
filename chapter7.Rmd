...
In order to measure these changes-- we often need to examine how each of the variables changes individually.

-   This can be defined mathematically as

-   However a table can also give us the marginal probabilities

...
-   If finite additivity is proven using the third axiom, why is it used to prove the 3rd axiom?
...
-   hint: for finite additive sets use mathematical induction
...
$$
\\
\text{Generalized Inclusion-Exclusion Principal}
\\
\text{}\mathbb{P}(ABC)
\tag{Theorem 2.6}
$$
...
A sample space can be described with the following notation
...
table_data <- data.frame(
  Name = c("Complement", "Sum Rule", "Difference Rule", "Certainty", "Impossibility", "Mutual Exclusivity"),
  Definition = c("The complement of event A is...",
                 ...
                 "The probability of the sample space (the set of all possible outcomes) is 1, which represents absolute certainty",
...
table_data <- data.frame(
  Name = c("Communicative", "Associative", "Distributive", "Demorgans First Law", "Demorgans Second Law"),

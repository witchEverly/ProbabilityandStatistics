# Special distributions of discrete random variables
...
> A binomial random variable is used for determining the number of successes in a fixed number of independent Bernoulli trials, all of which have the same fixed probability of success.

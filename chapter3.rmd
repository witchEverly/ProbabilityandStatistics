...
Conditional probability is not a theorem, nor a conjecture. It is not a lemma or a corollary. It aims to answer the question of how you should update probability based on updated evidence. It is philosophically intuitive idea that the conditional probability $\mathbb{P}(A|B)$ gives an advantage, when knowing the occurrence of $B$ changes the occurrence of $A$.

...
Consider the last name **Brungard** and the name **Karapanian**. One has repeating elements. If for some reason we wanted to know the possible ways to rearrange these letters:
